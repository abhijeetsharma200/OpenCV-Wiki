...
![OpenCV Ideas Page](https://perspectivemnnit.files.wordpress.com/2018/01/gsoc-title-new2.jpg)
...
April 4 - April 19 | Student Application Period |
...
September 5 - September 12 | Students Submit Code and Final Evaluations |
...
- [Student+Mentor Mailing List](https://groups.google.com/forum/#!forum/opencv-gsoc-2022)
...
3.  You must accept the request and **you are a mentor!**
   * You will also need to get on:
       ...
       * [The Student+Mentor Mailing List](https://groups.google.com/forum/#!forum/opencv-gsoc-2022)
4.  You then:
    ...
    - You will get a list of students who have applied to your project. Go through them and select a student or rejecting them all if none suits and joining to co-mentor or to quit this year are acceptable outcomes.
       - Make sure your students officially apply through the [Google Summer of Code site](https://summerofcode.withgoogle.com) prior to the deadline as indicate by the Student Application Period in the [time line](https://github.com/opencv/opencv/wiki/GSoC_2022#important-dates)
