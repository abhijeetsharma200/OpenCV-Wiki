...
| ------------------------ | ------------------------- | -------------- | ----------------- |
| [ Speech recognition](https://github.com/opencv/opencv/wiki/GSoC_2022#idea-speech-recognition-samples-using--audio-io-module) | [FP16 & BF16 for DNN](https://github.com/opencv/opencv/wiki/GSoC_2022#idea-FP16-and-BF16-Compute-Paths-in-OpenCV-DNN-module) | [Improved imgcodecs](https://github.com/opencv/opencv/wiki/GSoC_2022#idea-improved-imgcodecs) | [ Ficus bindings](https://github.com/opencv/opencv/wiki/GSoC_2022#idea-ficus-bindings) |
