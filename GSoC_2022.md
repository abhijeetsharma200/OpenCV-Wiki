...
1. #### _IDEA:_ Lightweight object detection models
   ...
   * ***Expected Outcomes:***
      1. One or more lightweight object detection models trained (or borrowed if the license is appropriate) and submitted to [OpenCV Model Zoo](https://github.com/opencv/opencv_zoo).
