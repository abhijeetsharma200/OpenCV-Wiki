...
| ----- | ----- | ------ | ------ |
| Sida Yi | Implementing multi-task CV models in OpenCV | Yuantao Feng | 👍  |
| Shivanshu Tyagi | AudioVisual Speech Recognition using OpenCV Audio IO Module | Jia Wu, Batanina Liubov | 👍 |
| Yiyao Wang | Lightweight OCR Models| Zihao Mu | 👍 |
| Maksym Ivashechkin | Upgrading RANSAC and multi-grid camera calibration | Jean-Yves Bouguet | 👍 |
| Chuyang Zhao | Efficient Data Augmentation Module in OpenCV for DL Training | Shiqi Yu, Jia Wu | 👍 |
| Gary Ding | FIRST Robotics with OAK-D Camera | Gary Bradski, Prasanna Krishnasamy | 👍 |
| Sri Siddarth Chakaravarthy | Lightweight object detection and tracking for resource restricted usage | Yuantao Feng | 👍 |
| Liutong HAN| Optimizing OpenCV Universal Intrinsic for RISC-V Vector | Shiqi Yu, Mingjie Xing | 👍 |
| Berke Yavas | Improved imgcodecs | Suleyman Turkmen | 👍 |
| Tong Zhang | Light-OCR | Zihao Mu | 👍 |
