...
1. #### _IDEA:_ Optimize OpenCV for RISC-V
   * ***Description:*** Last year we brought initial version of wide universal intrinsics for OpenCV that hopefully provide some acceleration for traditional vision algorithms. We also have accelaration by RVV for deep learning in order to achieve the best possible performance. But the support can be further improved.
   * ***Expected Outcomes:*** 
      * 
   * ***Resources:***
