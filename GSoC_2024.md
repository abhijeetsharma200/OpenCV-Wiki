...
----
#### _IDEA:_ Add support for HEIF image format 
   * ***Description:*** 
   * ***Expected Outcomes:***
   * ***Resources:***
...
#### _IDEA:_ Implementing and optimizing arbitrary Stable Diffusion algorithm using opencv
   * ***Description:*** 
   * ***Expected Outcomes:***
   * ***Resources:***
