...
#### _IDEA:_ Better ArUco functions in OpenCV
   * ***Description:*** ArUco was first integrated into _opencv_contrib_ repository by its author S. Garrido-Jurado in 2015. It was later improved and moved to the main repository in 2022 with the efforts of OpenCV community and core team. In 2019 the ArUco library's license was changed to GPL in 2019, and the version in OpenCV and that of the ArUco research group diverged since. The group has continued to develop on ArUco and made significant advancements. It will be benificial if these improvements could be incorporated into OpenCV.
   * ***Expected Outcomes:***
   * ***Resources:***
