...
* Vadim:
   ...
   * Another GSoC student, Zihao M., continues work on loop closure algorithm (DNN-based), and also on stackblur. The draft implementation of stackblur is ready, but it's currently a bit slower than GaussianBlur, at least on the moderate-size images & kernels.
