...
* Julia
   * fixed issues on DNN
   * re-including Lapak libraries on Linux (done) Windows (in progress)
   * CUDA backend for NLP networks LSTM

### Done:
   * Alexander S: Reviewed, helped to resolute issues with PRs ## 20569, 20761, 20762, 20712, 20636, 20742, 
   ...
   * Alexander P: merged PR to add radon checkerboard, issue #20735.
