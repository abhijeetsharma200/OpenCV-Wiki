...
* Egor: found easy to fix issues in existing layers using ONNX conformance tests, the percentage rose to 21.68%, which is not much, but considering we probably won’t be supporting control flow operations, it’s good enough. Opened PRs: 
