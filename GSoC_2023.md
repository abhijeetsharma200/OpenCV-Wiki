...
1. [Lightweight optical flow model](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-lightweight-object-detection-models)
...
1. [Multi-camera calibration part 2](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-multi-grid-multi-camera-calibration)
...
1. #### _IDEA:_ Multi-camera calibration part2
