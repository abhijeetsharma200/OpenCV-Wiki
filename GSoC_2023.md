...
* Merged Pull Requests from the previous GSoC programs: [opencv](https://github.com/opencv/opencv/pulls?q=is%3Apr+label%3Agsoc+is%3Aclosed) and [opencv_contrib](https://github.com/opencv/opencv_contrib/pulls?q=is%3Apr+label%3Agsoc+is%3Aclosed)
