...
          * Potentially have some DNN models where users can tune the models to their data that they provide, but GPT would know how to trains such models and get them on given hardware like OAK cameras, Mac, Windows, Linux.   * ***Resources:*** [OpenCV] (https://opencv.org/), [Git Code](https://github.com/opencv), [OpenAI](https://openai.com/)
   * ***Skills Required:*** good software development skills, good knowledge and use of GPT and of OpenCV
   * ***Possible Mentors:*** Doug Lee, Gary Bradski   * ***Difficulty:*** Medium to Hard
   * ***Duration:*** 200 hours
