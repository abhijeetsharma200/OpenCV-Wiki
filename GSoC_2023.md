...
![OpenCV Ideas Page](https://user-images.githubusercontent.com/810997/214670545-00571a4d-f473-46ca-97ea-e083c4b5a917.png)
_(https://www.cvat.ai/)_
...
1. [Audiovisual Speech Recognition](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-audiovisual-speech-recognition-demo)
1. [FP16 & BF16 for DNN](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-FP16-Compute-Paths-in-OpenCV-DNN)
1. [Improved imgcodecs](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-improved-imgcodecs)
1. [ Ficus bindings](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-ficus-bindings) |
...
1. [Image augmentation for DNN](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-image-augmentation-to-assist-dl-training)
1. [Multi-task CV models](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-multi-task-cv-models)
1. [Lightweight object detection models](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-lightweight-object-detection-models)
1. [Realtime object tracking models](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-realtime-object-tracking-models)
1. [Improved ArUco module](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-improved-aruco-module)
1. [Lightweight OCR models](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-lightweight-ocr-models)
1. [RISC-V Optimizations](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-risc-v-optimizations)
1. [Enable G-API in OpenCV.js](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-enable-g-api-in-opencvjs)
1. [First Robotics with OAK-D Camera](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-first-robotics-with-oak-d-camera)
1. [Multi-grid multi-camera calibration](https://github.com/opencv/opencv/wiki/GSoC_2023#idea-multi-grid-multi-camera-calibration)
