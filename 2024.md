...
* Vincent:
  ...
  * Observed degradation in calibration accuracy (C++ version in 4.x is worse than the old C implementation, but C++ implementation of LevMarq in 5.x should be better than both).
* Shiqi:
  * The new Wechat QR code evaluation: just finished evaluation. Will prepare PR within 1-2 weeks.
