...
* Vincent:
  ...
  * custom InputArrays for OpenCV 5 (https://github.com/opencv/opencv/issues/20869).
  * int64 definition ambiguity for OpenCV 5 (https://github.com/opencv/opencv/issues/7573)
