...
* Alexander S (x.ai):
  * Done:
    * Andrey:
      * Prepared WinPack build with OpenCV Contrib modules ([artifact](https://drive.google.com/file/d/1Xb4NqRJ-cq7R00TQor0krbwebYX9ThYs/view?usp=sharing)). [#62](https://github.com/opencv/ci-gha-workflow/pull/62)
