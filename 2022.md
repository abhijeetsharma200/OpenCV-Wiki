...
* Vadim:
  * accelerated DNN using fixed FP32+FP16 (ARM v8.2 instructions). Resnet-50 now takes 17.6ms, Mobilenet 3.3ms. The patch with FP16 compute path in convolution will be added after the new FP32 acceleration is integrated.
