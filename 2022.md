...
* Alexandr P: cv::aruco::detectMarkers consumes all available memory when CORNER_REFINE_CONTOUR #2738 
   ...
   * prepared [PR fix CORNER REFINE CONTOUR #3186](https://github.com/opencv/opencv_contrib/pull/3186)
   * awaiting review
* Aleksandr P: [Charuco seems inaccurate. #3175](https://github.com/opencv/opencv_contrib/issues/3175)
   * checked and closed
...
* Aleksandr P: CharucoBoard_create wrong [internal marker position #2623](https://github.com/opencv/opencv_contrib/issues/2623)
...
* Git hub ticket -- support new camera
   * Raspberry Pi camera support to OpenCV (HW side)
      * https://github.com/opencv/opencv/issues/21653
         * This github ticket links to the [libcamera site](https://libcamera.org/open-projects.html)
   * Propose joint effort
* OpenVino has Cuda plugin
* Shiqi Yu
