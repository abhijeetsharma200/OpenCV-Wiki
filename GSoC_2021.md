...
| [&nbsp; Point Cloud Fit](https://github.com/opencv/opencv/wiki/GSoC_2021#idea-finalize-planespherecylinder-fitting-code) | [Demo for Android](https://github.com/opencv/opencv/wiki/GSoC_2021#idea-demo-for-android) |  [Extend transpose operator](https://github.com/opencv/opencv/wiki/GSoC_2021#idea-extend-transpose-operator-for-matnd-mat-with-channels-and-extend-api) | [Type annotations for Python package](https://github.com/opencv/opencv/wiki/GSoC_2021#idea-improve-python-package-with-type-annotations-and-type-checking) | [&nbsp; Accelerate OpenCV.js DNN via WebNN](https://github.com/opencv/opencv/wiki/GSoC_2021#idea-accelerate-opencvjs-dnn-via-webnn)
