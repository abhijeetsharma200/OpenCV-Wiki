...
* Vadim
  ...
  * [OpenCV China] Zhong Wangli: prepared very efficient pose estimation model for OpenCV model zoo, 8-bit quantized model takes 11ms on Intel CPU (model ???) and ~30ms on Khadas VIM3. 
* Alexander S (xperience.ai):
  * There are some changes in OpenCV team, some members in, some out
  * Done:
