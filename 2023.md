...
* Vincent:
  ...
  * Working on more generating more fuzz-based tests for OpenCV. Some preliminary results: https://github.com/google/oss-fuzz/compare/master...vrabaud:oss-fuzz:master,  https://github.com/opencv/opencv/compare/4.x...vrabaud:opencv:fuzztest.
    ```
