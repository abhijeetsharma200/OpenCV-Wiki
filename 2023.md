...
* Vadim:
  * [OpenCV China] PR with faster MatMul in DNN for faster transformers (https://github.com/opencv/opencv/pull/24694) has been merged. Attention acceleration PR (https://github.com/opencv/opencv/pull/24476) is almost ready; will try to squeeze it into 4.9.0.
  * Regression in convolution is likely fixed (https://github.com/opencv/opencv/pull/24709). Depth-wise convolution still needs to be optimized.
* Alexader S (opencv.ai):
  * Done:
    * Alexander Panov:
      * Prepared PR Update android OpenCL sample [#24715](https://github.com/opencv/opencv/pull/24715)
      * Fixed CMake, gradle, sample and tutorial
      * Successfully build OpenCV on Android with OpenCL and tested sample
      * Updated description in issue Problems with adding OpenCV to Android Studio project [#24663](https://github.com/opencv/opencv/issues/24663) (added solution to include OpenCV)
      * Reviewed findChessboardCorners performance degradation fix for some cases [#24558](https://github.com/opencv/opencv/pull/24558)
      * Works with Unify build.gradle generation for Android projects [#24686](https://github.com/opencv/opencv/issues/24686)
    * Alexander Smorkalov:
...
* Alexander S (opencv.ai):
  * Done:
    * Alexander Panov:
      * Reviewed and tested [#24639](https://github.com/opencv/opencv/pull/24639), #24599, #24616
      * Reviewed and tested ChessBoardDetector::findQuadNeighbors [#24605](https://github.com/opencv/opencv/pull/24605), #24597
      * Refreshed tutorial for Android mobilenet ssd detector ([Doc](https://docs.google.com/document/d/1l4mJ7HsOV1z_ypxfp1LU4pk81d7nyY-qAyNIpW_iydI/edit))
      * Fixed and merged PR Add android QR detection sample [#24598](https://github.com/opencv/opencv/pull/24598)
    * Abduragim Shtanchaev:
      * Worked on community reported issues with yolo model such as [#23977](https://github.com/opencv/opencv/issues/23977),  [#24635](https://github.com/opencv/opencv/issues/24635)
    ...
    * Rostislav Vasilikhin:
      * Created draft PR with video writing sample: [#24592](https://github.com/opencv/opencv/pull/24592)
      * Tutorials for Android development: in progress [#24653](https://github.com/opencv/opencv/pull/24653)
    * Alexander Lyulkov:
...
* Alexander S (opencv.ai):
  * Done:
    * Alexander Panov:
      ...
      * Reviewed PRs change binarization in findChessboardCorners() [#24564](https://github.com/opencv/opencv/pull/24564) and       * findChessboardCorners performance degradation fix for some cases [#24558](https://github.com/opencv/opencv/pull/24558)
    * Abduragim Shtanchaev:
...
* Alexander S (opencv.ai):
  * Done (summary for 2 weeks):
    * Alexander Panov:
      ...
      * Build and run on phone OpenCV Android samples, preparing new Android samples with QR code, created [docs](https://docs.google.com/document/d/1s--DRkf-zNWt2Lb52L8AsVb8oF3Jtzod2EwhXqgW5ME/edit) with tested build flags
    * Abduragim Shtanchaev:
