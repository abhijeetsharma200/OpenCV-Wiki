...
* Vadim:
  * [OpenCV China] Yuantao made RAFT model compatible with OpenCV; gives the same results as ONNXruntime.
...
* Vincent:
  * continue working on resize (INTER_AREA). C++ compiler seems to be doing good work on horizontal resize.
...
* Gary:
  * continue to work on NERFs (Gaussian splatting in particular). The "inference" part can be made really fast.
