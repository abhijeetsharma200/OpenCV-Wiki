...
* Alexander S (opencv.ai):
  ...
  * Q by Shiqi: which QR detector is better, the new one (based on AruCO tech) or the one by WeChat team? Can we combine it. A: generally the new QR detector is better, e.g. it handles the cases of sign
